# 👨‍💻 Ahmed Sefdine | Data Analyst & Statistics Specialist
...
> *Transformer les données complexes en insights stratégiques*

**Data Analyst** passionné avec **2+ années d'expérience** en analyse statistique et modélisation des données. Actuellement en **Master Statistique et Informatique Décisionnelle**, je me spécialise dans l'analyse de survie appliquée aux données médicales, notamment l'étude du cancer gastrique au Sénégal.

```python
class AhmedSefdine:
    def __init__(self):
        self.role = "Data Analyst & Researcher"
        self.location = "Dakar, Sénégal 🇸🇳"
        self.education = "Master en Statistique et Informatique Décisionnelle"
        self.research_focus = ["Analyse de Survie", "Statistiques Médicales", "Machine Learning"]
        self.languages = ["Python", "R", "SQL", "SAS"]
        
    def current_mission(self):
        return "Extraire la valeur cachée dans les données pour des décisions éclairées"
```
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=sefdineahmed&theme=tokyo-night&hide_border=true&area=true" alt="Contribution Graph" />
...
**Je suis toujours ouvert à des opportunités de collaboration, de recherche ou de consulting !**
...
<!-- Alternative si le snake ne fonctionne pas -->
<!-- Utilisez cette ligne à la place : -->
<!-- ![](https://raw.githubusercontent.com/sefdineahmed/sefdineahmed/output/github-contribution-grid-snake.svg) -->
