...
> *"Transformer les données complexes en décisions stratégiques éclairées"*

🔬 **Data Analyst & Statisticien** avec **2+ années d'expérience** en analyse statistique avancée et informatique décisionnelle

🎓 **Master en Statistique et Informatique Décisionnelle** - Spécialisation en analyse de survie appliquée aux données médicales

🔍 **Domaine de recherche actuel :** Analyse de survie du cancer gastrique au Sénégal (modèles de Kaplan-Meier, régression de Cox)
...
![SAS](https://img.shields.io/badge/SAS-0078D4?style=for-the-badge&logo=sas&logoColor=white)
...
![SPSS](https://img.shields.io/badge/SPSS-1F6BBD?style=for-the-badge&logo=ibm&logoColor=white)
![Stata](https://img.shields.io/badge/Stata-1A4674?style=for-the-badge&logo=stata&logoColor=white)
...
<details>
<summary><b>🔬 Recherche Académique</b></summary>

### Analyse de Survie - Cancer Gastrique au Sénégal
- **Objectif :** Étudier les facteurs pronostiques et la survie des patients
- **Méthodes :** Kaplan-Meier, Test Log-Rank, Modèle de Cox
- **Outils :** R (survival, survminer), Python (lifelines), SAS
- **Impact :** Identification de facteurs de risque significatifs pour améliorer la prise en charge
...
### Dashboards Interactifs & Reporting
- **Power BI :** Tableaux de bord executives avec KPIs temps réel
- **Tableau :** Visualisations interactives pour l'analyse des ventes
- **Streamlit :** Applications web pour la data science
- **Automatisation :** Scripts Python pour reporting périodique
...
- **Classification :** Prédiction de churn clients, scoring crédit
- **Régression :** Prévisions de ventes, estimation de prix
- **Clustering :** Segmentation client, analyse de comportement
- **Time Series :** Prévisions de demande, analyse de tendances
...
[![Email](https://img.shields.io/badge/Email-ahmed.sefdine@uadb.edu.sn-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ahmed.sefdine@uadb.edu.sn)
...
[![GitHub](https://img.shields.io/badge/GitHub-Suivez--moi-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sefdineahmed)
...
🌍 **Basé au Sénégal**, je contribue à la communauté data science africaine  
☕ **Alimenté par le café** et la passion pour les statistiques  
📚 **Lecteur avide** de publications scientifiques et blogs tech  
🎯 **Objectif 2025 :** Publier 3 articles de recherche et contribuer à 10 projets open source
